// фикс от потери прокрутки при открытии модального окна

// при открытии
const htmlElem = document.documentElement;
let scrollPosition = window.pageYOffset;

htmlElem.style.top = -scrollPosition + "px";
htmlElem.classList.add("hystmodal__opened");

// при закрытии

htmlElem.classList.remove("hystmodal__opened");
// вернут окно туда, где оно было
